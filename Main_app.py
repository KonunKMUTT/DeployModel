...
def main():
    ...
    if st.button("Predict"):
        ...
        styled_result = f'<p style="color:{color}; font-size:20px; text-align:center; font-weight:bold; background-color:#4B4A54; padding:10px; border-radius: 25px;">AI for Heart Disease Predicted is: {result}</p>'
